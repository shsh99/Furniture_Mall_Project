              ...
              <div className="intro-excerpt">
                ...
                <p>
                  <div className="input-group-append">
                    <Link to="/faq" className="btn btn-bl-outline mb-4">
                      자주 묻는 질문
                    </Link>
                  </div>
                </p>
                <h6>운영시간 : (월요일 - 일요일) 10:00 - 20:00</h6>
                <h6 className="mb-5">*추석, 설날은 휴무입니다.</h6>
              </div>
            </div>
            ...
            <div className="row mb-5 justify-content-center">
              <div className="col-12 w-50 input-group mb-3">
                ...
                <div className="input-group-append">
                  ...
                  <Link to="/add-notice" className="btn btn-secondary">
                    글쓰기
                  </Link>
                </div>
              </div>
              ...
              <div className="accordion" id="accordionExample">
                ...
                {notice &&
                  notice.map((data, index) => (
                    <div className="accordion-item" key={data.noticeNo}>
                      ...
                      >
                        <div className="accordion-body">
                          {/* 벡엔드 데이터 코딩 */}
                          {data.noticeContents} &nbsp;
                          <Link to={"/notice/" + data.noticeNo}>
                            <span className="badge bg-success">수정하기</span>
                          </Link>
                        </div>
                      </div>
                      {/* 본문 끝 */}
