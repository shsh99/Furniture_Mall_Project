...
import PayService from "../../../service/shop/pay/PayService";
...
function Payment() {
  ...
  const [ payment, setPayment] = useState<IPay>(initialPayment);

 

  const deleteItem = () => {
    PayService.remove(payment.itemNo, payment.email) // 백엔드로 삭제요청
      .then((response: any) => {
  ...
  const handleInputChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setPayment({ ...payment, [name]: value }); // 변수저장
  };
              ...
              <div className="site-blocks-table">
                ...
                <div>
                  ...
                  <input
                    ...
                    name="shippingInfo"
                  />
                  <label htmlFor="bill_info" className="check">
                    &nbsp;주문 정보와 배송 정보가 같습니다.
                  </label>
                </div>
              </div>
                ...
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>$49.00</td>
                      <td>
                        <button onClick={deleteItem} className="btn btn-black btn-sm">
                          X
                        </button>
                      </td>
                    </tr>
