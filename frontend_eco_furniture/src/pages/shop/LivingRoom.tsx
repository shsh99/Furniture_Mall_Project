...
function LivingRoom() {
  ...
  const blogEntries: BlogEntry[] = [
    { image: "images/거실/거실1.jpg", title: "살로몬 직사각 거실" },
    { image: "images/거실/거실2.jpg", title: "살로몬 직사각 거실" },
    { image: "images/거실/거실3.jpg", title: "살로몬 직사각 거실" },
    { image: "images/거실/거실4.jpg", title: "살로몬 직사각 거실" },
    { image: "images/거실/거실5.png", title: "살로몬 직사각 거실" },
    { image: "images/거실/거실6.jpg", title: "살로몬 직사각 거실" },
    // ... (나머지 블로그 엔트리)
  ];
