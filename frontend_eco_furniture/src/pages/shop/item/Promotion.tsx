                    ...
                    <div className="d-flex row justify-content-between">
                        <div className="col-lg-10">
                            <div className="mt-5">
                                ...
                                <div className="d-flex justify-content-around align-items-center">
                                    <div className="mx-2">
                                        <img src={require("../../../assets/images/santa.jpg")} className="d-block img-fluid mx-1" alt="..." style={{ width: '200px', height: '150px' }} />
                                        <p className="text-center">겨울 조명</p>
                                    </div>
                                    <div className="mx-2">
                                        <img src={require("../../../assets/images/citem2.jpg")} className="d-block img-fluid mx-1" alt="..." style={{ width: '200px', height: '150px' }} />
                                        <p className="text-center">겨울 장식/데코</p>
                                    </div>
                                    <div className="mx-2">
                                        <img src={require("../../../assets/images/item2.jpg")} className="d-block img-fluid mx-1" alt="..." style={{ width: '200px', height: '150px' }} />
                                        <p className="text-center">겨울 화분 </p>
                                    </div>
                                    <div className="mx-2">
                                        <img src={require("../../../assets/images/ctree1.jpg")} className="d-block img-fluid mx-1" alt="..." style={{ width: '200px', height: '150px' }} />
                                        <p className="text-center">크리스마스 트리</p>
                                    </div>
                                    <div className="mx-2">
                                        <img src={require("../../../assets/images/item1.jpg")} className="d-block img-fluid mx-1" alt="..." style={{ width: '200px', height: '150px' }} />
                                ...
                                <div className="ml-3" >
                                    <div className="card-body" style={{ maxWidth: '400px', height: 'auto' }}>
                                        ...
                                        <div className="card-body mt-3" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                            <img src={require("../../../assets/images/santa.jpg")} className="card-img-top" alt="..." style={{ width: '100%', height: 'auto', objectFit: 'cover' }} />
                                        </div>
                                    </div>
                                </div>
                                <div className="ml-3" style={{ maxWidth: '400px' }}>
                                    <img src={require("../../../assets/images/christmas.jpg")} className="card-img-top" alt="..." style={{ width: '100%', height: 'auto' }} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-10 mt-5">
                            <div className="mt-5">
                                ...
                                <div className="d-flex justify-content-around align-items-center">
                                    <div className="mx-2">
                                        <img src={require("../../../assets/images/citem1.jpg")} className="d-block img-fluid mx-1" alt="..." style={{ width: '200px', height: '150px' }} />
                                        <p className="text-center">겨울 조명</p>
                                    </div>
                                    <div className="mx-2">
                                        <img src={require("../../../assets/images/citem2.jpg")} className="d-block img-fluid mx-1" alt="..." style={{ width: '200px', height: '150px' }} />
