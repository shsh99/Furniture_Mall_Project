      ...
      <div className="container">
        <div className="d-flex row justify-content-between">
          <div className="col-lg-10">
            <div className="mt-5">
              <h1 className="bestt">인테리어 소품</h1>

              <div className="d-flex mt-5">
                <h2>내방 스타일에 맞는 홈퍼니싱 제품 </h2>
              </div>
            </div>
          </div>
...
{
  /* function setSideBar(arg0: (prevState: any) => boolean) {
    throw new Error('Function not implemented.');
}
function setShowSubMenu(arg0: boolean) {
    throw new Error('Function not implemented.');
} */
}
