...
function BedRoom() {
  ...
  const blogEntries: BlogEntry[] = [
    {
      image: require("../../assets/images/bedRoom/bedRoom1.jpg"),
      title: "살로몬 직사각 침실",
    },
    {
      image: require("../../assets/images/bedRoom/bedRoom2.jpg"),
      title: "살로몬 직사각 침실",
    },
    {
      image: require("../../assets/images/bedRoom/bedRoom3.jpg"),
      title: "살로몬 직사각 침실",
    },
    {
      image: require("../../assets/images/bedRoom/bedRoom4.jpg"),
      title: "살로몬 직사각 침실",
    },
    {
      image: require("../../assets/images/bedRoom/bedRoom5.jpg"),
      title: "살로몬 직사각 침실",
    },
    {
      image: require("../../assets/images/bedRoom/bedRoom6.jpg"),
      title: "살로몬 직사각 침실",
    },
    // ... (나머지 블로그 엔트리)
  ];
            ...
            {blogEntries.map((entry, index) => (
              <div className="col-12 col-sm-6 col-md-4 mb-5" key={index}>
                <div className="post-entry">
                  ...
                  <Link
                    to="#"
                    onClick={(e) => handleImageClick(e, entry.image)}
                  >
                    <img
                      src={entry.image}
                      alt="Image"
              ...
              <div className="item mb-5 card" style={{ height: "auto" }}>
                <div className="position-relative">
                  <img
                    className="img-fluid"
                    style={{ height: "" }}
                    src={require("../../assets/images/item2.jpg")}
                    alt=""
                  />
                </div>
                <div className="p-4">
              ...
              <div className="item mb-5 card" style={{ height: "auto" }}>
                <div className="position-relative">
                  <img
                    className="img-fluid"
                    style={{}}
                    src={require("../../assets/images/ctree1.jpg")}
                    alt=""
                  />
                </div>
                <div className="p-4">
            ...
            <div className="col-lg-3 mb-lg-4">
              <div className="product-item-sm d-flex">
                ...
                <div className="pt-3">
                  <h3>빠른 배송 &amp; 무료 배송</h3>
                  <p>
                    저희 Eco Furniture는 언제나 고객님들을 위해 당일 출고, 무료
                    배송을 지원합니다!
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-3 mb-lg-4">
              <div className="product-item-sm d-flex">
                ...
                <div className="pt-3">
                  <h3>편리한 반품</h3>
                  <p>
                    인테리어가 어울리지 않아서, 제품에 문제가 있어서 등 환불,
                    반품을 하실 때 신속하게 처리합니다!
                  </p>
                </div>
              </div>
