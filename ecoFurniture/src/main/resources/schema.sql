...
DROP SEQUENCE TB_SHOP_CARTS_SEQUENCE;
...
CREATE SEQUENCE TB_SHOP_CARTS_SEQUENCE START WITH 1 INCREMENT BY 1;
...
DROP TABLE TB_SHOP_CARTS CASCADE CONSTRAINT;
...
(
    ...
    ITEM_PRICE  NUMBER(10,0) NOT NULL,
    ...
    CONSTRAINT FK_SHOP_ITEM_IMAGES FOREIGN KEY (UUID) REFERENCES TB_SHOP_ITEM_IMAGES (UUID),
    CONSTRAINT FK_SHOP_ITEM_CODE_ID FOREIGN KEY (CODE_ID) REFERENCES TB_CODE (CODE_ID)
);

CREATE TABLE TB_SHOP_CARTS
(
    CART_NO           NUMBER(10) NOT NULL,
    EMAIL             VARCHAR2(100) NOT NULL,
    CART_ORDER_AMOUNT NUMBER(5),
    CART_ALL_PRICE    NUMBER(20,0) NOT NULL,
    CONSTRAINT PK_SHOP_CARTS PRIMARY KEY (CART_NO),
    CONSTRAINT FK_SHOP_CARTS_CUSTOMER FOREIGN KEY (EMAIL) REFERENCES TB_USER (EMAIL)
);

CREATE TABLE TB_SHOP_CART_ITEM
(
    CART_ITEM_NO    NUMBER(10) NOT NULL,
    CART_ITEM_COUNT NUMBER(5),
    ITEM_NO         NUMBER(5) NOT NULL,
    CART_NO         NUMBER(5) NOT NULL,
    CONSTRAINT PK_SHOP_CART_ITEM PRIMARY KEY (CART_ITEM_NO),
    CONSTRAINT FK_SHOP_ITEM_CARTS FOREIGN KEY (ITEM_NO) REFERENCES TB_SHOP_ITEMS (ITEM_NO),
    CONSTRAINT FK_SHOP_CART_ITEM FOREIGN KEY (CART_NO) REFERENCES TB_SHOP_CARTS (CART_NO)
);
...
(
    ...
    ORDER_PAYMENT_METHOD VARCHAR2(15) NOT NULL,
    ORDER_TOTAL_PRICE    NUMBER(20,0) NOT NULL,
    EMAIL                VARCHAR2(100) NOT NULL,
    ORDER_USE_POINT      NUMBER(5),
    CONSTRAINT PK_SHOP_ORDERS PRIMARY KEY (ORDER_NO),
    CONSTRAINT FK_SHOP_ORDERS_CUSTOMER FOREIGN KEY (EMAIL) REFERENCES TB_USER (EMAIL)
);
...
(
    ...
    CONSTRAINT FK_LIKE_CUSTOMER FOREIGN KEY (EMAIL) REFERENCES TB_USER (EMAIL)
);
